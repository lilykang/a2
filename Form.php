...
# This is to prevent name collisions; provide more specificity
# The below namespace specifies all the names are specific to the namespace of DWA
namespace DWA;

# The following code is directly borrowed from DWA course's GitHub
# Source: https://github.com/susanBuck/dwa15-php-practice/blob/master/Form.php -->
            ...
            foreach($rules as $rule) {
                ...
                if(!$test) {
                    ...
                    if($fieldName == 'pagesRead'){
                        $errors[] = 'The number of pages you read '.$this->getErrorMessage($rule, $parameter);
                    }

                    elseif($fieldName == 'minWorkout'){
                        $errors[] = 'The number of minutes you worked out '.$this->getErrorMessage($rule, $parameter);
                    }
